...
# use the assignment operator <- to assign values/objects to variables
...
# create three variables butteflies, bumblebees and
# dragonflies and assign counts to each variable.
...
# one is a numeric and the other a character


# determine the class of data types using class() 
...
# use the combine function c(), to create a numeric vector (1,2,3,4)
# and assign it to the variable my_numeric


# create a character vector (dog, cat, goldfish) and 
# assign it to the variable my_pets


#####  TRY IT OUT  ##### 
# you have measured grain yield (t/ha) on five winter barley varieties
# under drought stress and irrigation.
# the varieties are Carola, Frost, Goldrush, Princess, and Malta
# for irrigation treatment yields are 17.4, 14.2, 15.2, 10.3, 15.6
# for drought treatment yields are 15.4, 12.2, 11.2, 6.3, 14.9
...
# it is good practice to name elements in your vector so
# that you know what they refer to. This can be accomplished
# very easily with the names function, names()

# create a vector of monthly average temperatures
...
#####  TRY IT OUT  ##### 
# Go back to your yield example and give variety names to
...
# create a vector of number of apples in three baskets
# and create a vector of number of kiwis in three baskets


# add the two vectors together and assign to variable fruit



#####  TRY IT OUT  ##### 
# Go back to your yield example and figure out the difference
# between yield under irrigated and drought conditions for
# each variety and assing to the variable yield_diff
...
# create two vectors (monthly temperature in France and Ireland) and 
# see if France is hotter than Ireland
...
# create a vector of insects and assign to insect


# select out the third element of the vector
...
# variable cts100, second use this variable to select out
# the appropriate data from cts (print variables at each stage)



#####  TRY IT OUT  ##### 
# Go back to your grain yield example and select out the
# the varieties that have less than or equal to 1 tonne drop
# in grain yield under drought
...
# and put into 5 rows and assign it to mat1
...
# 2018 scores and one with 2019 scores)
# finally create a vector of row names and a vector of column
# names and label the all_sites matrix
...
#####  TRY IT OUT  #####
# using the all_sites matrix convert values to a 0-10
# scale by dividng each element in the matrix by 10


# adding new data (e.g. 2020) to matrix 
...
# for 2019 from your all_sites matrix 
...
# its a big data frame - lets look at the first few rows


# or the last few rows


# it can be useful to look at the structure of the data frame
...
# next assign Petal Widths to a variable named petalWidth
...
# the last data structure to look at is a list
...
# we create a list with the list() function and assing to my_list
...
# from the matrix compnent in the list you created above
